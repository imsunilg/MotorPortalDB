...
BEGIN
    SELECT mp.MASTER_POLICY_ID, mp.CD_BALANCE, pr.PREMIUM_AMOUNT
    INTO v_master_policy_id, v_balance, v_amount
    ...
    IF v_balance < v_amount THEN
        RAISE EXCEPTION 'Insufficient CD balance for master policy id %', v_master_policy_id;
    END IF;
